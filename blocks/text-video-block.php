<div class="text-video-block">
    <div class="container">
                        ...
                        <div class="points">
                            <?php while(have_rows('points')): the_row(); ?>
                                <div class="single-point">
                                    <p class="title"><?php echo get_sub_field('info'); ?></p>
                                    <p class="value"><?php echo get_sub_field('value'); ?></p>
                                </div>
                            <?php endwhile; ?>
                        </div>
                    <?php endif; ?>

                    <?php if(get_field('icon') && get_field('green_text')): ?>
                        <div class="icon-text">
                            <div class="icon">
                                <img src="<?php echo get_field('icon'); ?>" alt="<?php echo get_field('green_text'); ?>">
                            </div>
                            <p class="green"><?php echo get_field('green_text'); ?></p>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <div class="wrapper second">
            ...
            <div class="right bg">
                <div class="content">
                <?php if(get_field('big_number')): ?>
                    <p class="number"><?php echo get_field('big_number'); ?></p>
                <?php endif; ?>
                <?php if(get_field('number_text')): ?>
                    <p class="text"><?php echo get_field('number_text'); ?></p>
                <?php endif; ?>
                </div>
            </div>
        </div>
